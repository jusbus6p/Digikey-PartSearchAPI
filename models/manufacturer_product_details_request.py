...
class ManufacturerProductDetailsRequest(object):
    ...
    def __init__(self, manufacturer_product=None, record_count=None, record_start_position=None, filters=None, sort=None, requested_quantity=None, search_options=None, _configuration=None):  # noqa: E501
    ...
    def manufacturer_product(self, manufacturer_product):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and manufacturer_product is None:
            raise ValueError("Invalid value for `manufacturer_product`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                manufacturer_product is not None and len(manufacturer_product) > 250):
            raise ValueError("Invalid value for `manufacturer_product`, length must be less than or equal to `250`")  # noqa: E501
        if (self._configuration.client_side_validation and
                manufacturer_product is not None and len(manufacturer_product) < 1):
    ...
    def record_count(self, record_count):
        ...
        """
        if (self._configuration.client_side_validation and
                record_count is not None and record_count > 50):  # noqa: E501
            raise ValueError("Invalid value for `record_count`, must be a value less than or equal to `50`")  # noqa: E501
        if (self._configuration.client_side_validation and
                record_count is not None and record_count < 1):  # noqa: E501
