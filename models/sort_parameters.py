...
class SortParameters(object):
    ...
    def __init__(self, sort_option=None, direction=None, sort_parameter_id=None, _configuration=None):  # noqa: E501
    ...
    def sort_option(self, sort_option):
        ...
        :type: SortOption
        """
        if self._configuration.client_side_validation and sort_option is None:
