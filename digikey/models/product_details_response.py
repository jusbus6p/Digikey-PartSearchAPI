...
class ProductDetailsResponse(object):
    ...
    def __init__(self, product_details=None, _configuration=None):  # noqa: E501
        """ProductDetailsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductDetailsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductDetailsResponse):
            return False
