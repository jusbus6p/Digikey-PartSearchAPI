...
class KeywordSearchRequest(object):
    ...
    def __init__(self, keywords=None, record_count=None, record_start_position=None, filters=None, sort=None, requested_quantity=None, search_options=None, exclude_market_place_products=None, _configuration=None):  # noqa: E501
        ...
        self._exclude_market_place_products = False
    ...
    def to_dict(self, api_friendly=False):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KeywordSearchRequest, dict):
            for key, value in self.items():
                result[key] = value
        if api_friendly:
            new_result = {}
            for key in result.keys():
                new_key = self.attribute_map[key]
    ...
    def to_str(self, api_friendly=False):
        """Returns the string representation of the model"""
        if api_friendly:
            return pprint.pformat(self.to_dict(api_friendly=True))
        else:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordSearchRequest):
            return False
