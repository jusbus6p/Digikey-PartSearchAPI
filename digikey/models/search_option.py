...
class SearchOption(object):
    ...
    LEADFREE = "LeadFree"
    COLLAPSEPACKAGINGTYPES = "CollapsePackagingTypes"
    EXCLUDENONSTOCK = "ExcludeNonStock"
    HAS3DMODEL = "Has3DModel"
    HASMENTORFOOTPRINT = "HasMentorFootprint"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """SearchOption - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchOption, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchOption):
            return False
